...
export default function Login() {
  ...
  //         <button type="button" className="px-6 py-2 bg-red-600 rounded-md" onClick={() => signOut()}>
  //           Sign out
  //         </button>
  //       </div>
  //     );
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-screen">
      ...
      <button type="button" className="px-6 py-2 mb-2 bg-blue-600 rounded-md" onClick={() => signIn("google")}>
        Sign in with google
      </button>
    </div>
  );
